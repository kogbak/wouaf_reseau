            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3"> <!-- A MODIFIER-->
                            <label for="wouafname" class="col-md-4 col-form-label text-md-end">{{ __('Pseudo : ') }}</label>

                            <div class="col-md-6">
                                <input id="wouafname" type="text" class="form-control @error('wouafname') is-invalid @enderror" name="wouafname" value="{{ old('wouafname') }}" required autocomplete="wouafname" autofocus>
